...
<head>
  ...
  <title>Fingerprint Image Enhancement & Reconstruction Console</title>
  <style>
    :root {
...
<body>
  <div class="shell">
    <div class="topbar">
      <div class="brand">
        <h1>Fingerprint Image Enhancement & Reconstruction</h1>
...
def create_pdf_report(case_dir: Path, source_name: str, result_payload: dict) -> Path:
    ...
    with PdfPages(pdf_path) as pdf:
        ...
        fig.text(0.08, 0.95, "Fingerprint Image Enhancement & Reconstruction Report", fontsize=20, fontweight="bold", color="#14333b")
